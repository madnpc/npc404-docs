...
#
# Resolution:
#   1. $PLAN_ID env var → ./docs/.planning/$PLAN_ID/
#   2. ./docs/.planning/.active_plan
#   3. Newest ./docs/.planning/<dir>/ by mtime
...
case "${mode}" in
    ...
    attest)
        ...
        # docs/.planning/<slug>/, where each session pins PLAN_ID and gets its own
