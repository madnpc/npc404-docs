...
- [ ] Identify opportunities for deep modules using codebase-design principles when interface boundaries are unclear. Do not invoke another skill automatically unless the user explicitly asks.
